                    ...
                    return GestureDetector(
                        onTap: () {
                          setState(() {
                            ...
                            if (index == 0) {
                              homeCtrl.imageHeight = size.height * 0.7;
                              homeCtrl.imageWidth = size.width * 0.75;
                            } else if (index == 1) {
                              homeCtrl.imageHeight = size.height * 0.33;
                              homeCtrl.imageWidth = Get.width;
                            } else if (index == 2) {
                              homeCtrl.imageHeight = size.height * 0.45;
                              homeCtrl.imageWidth = size.width * 0.75;
                            } else if (index == 3) {
                              homeCtrl.imageHeight = size.height * 0.4;
                              homeCtrl.imageWidth = Get.width;
                            } else if (index == 4) {
                              homeCtrl.imageHeight = size.height * 0.35;
